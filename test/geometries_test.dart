...
void main() {
  ...
  group("PredicateShortCircuitTest - ", () {
    ...
    List<String> polyInsidePoly = [
      "POLYGON (( 0 0, 100 0, 100 100, 0 100, 0 0 ))",
      "POLYGON (( 10 10, 90 10, 90 90, 10 90, 10 10 ))"
    ];
    List<String> polyPartiallyOverlapsPoly = [
      "POLYGON (( 10 10, 100 10, 100 100, 10 100, 10 10 ))",
      "POLYGON (( 0 0, 90 0, 90 90, 0 90, 0 0 ))"
    ];
    List<String> polyTouchesPolyAtPoint = [
      "POLYGON (( 10 10, 100 10, 100 100, 10 100, 10 10 ))",
      "POLYGON (( 0 0, 10 0, 10 10, 0 10, 0 0 ))"
    ];
    List<String> polyTouchesPolyAtLine = [
      "POLYGON (( 10 10, 100 10, 100 100, 10 100, 10 10 ))",
  ...
  group("PrecisionModelTest - ", () {
    ...
    test("testGetMaximumSignificantDigits", () {
      ...
      assertEquals(
          1,
          new PrecisionModel.fromType(PrecisionModel.FIXED)
              .getMaximumSignificantDigits());
      assertEquals(
          4,
          new PrecisionModel.fixedPrecision(1000)
              .getMaximumSignificantDigits());
    });
  ...
  group("PointImplTest - ", () {
    ...
    test("testEquals", () {
      Geometry? p1 = reader.read("POINT(1.234 5.678)");
      Geometry? p2 = reader.read("POINT(1.234 5.678)");
    ...
    test("testNegRounding1", () {
      Geometry? pLo = reader.read("POINT(-1.233 5.678)");
      Geometry? pHi = reader.read("POINT(-1.232 5.678)");

      Geometry? p1 = reader.read("POINT(-1.2326 5.678)");
      Geometry? p2 = reader.read("POINT(-1.2325 5.678)");
      Geometry? p3 = reader.read("POINT(-1.2324 5.678)");
    ...
    test("testIsSimple", () {
      Geometry? p1 = reader.read("POINT(1.2324 5.678)");
      assertTrue(p1!.isSimple());
      Geometry? p2 = reader.read("POINT EMPTY");
  ...
  group("NormalizeTest - ", () {
    ...
    test("testNormalizePoint", () {
      Geometry? point = reader.read("POINT (30 30)");
      point!.normalize();
    ...
    test("testComparePoint", () {
      Geometry? p1 = reader.read("POINT (30 30)");
      Geometry? p2 = reader.read("POINT (30 40)");
    ...
    test("testNormalizeMultiPoint", () {
      Geometry? m =
          reader.read("MULTIPOINT(30 20, 10 10, 20 20, 30 30, 20 10)");
      m!.normalize();
      Geometry? expectedValue =
          reader.read("MULTIPOINT(10 10, 20 10, 20 20, 30 20, 30 30)");
      assertEqualsExact(expectedValue!, m);
      Geometry? unexpectedValue =
          reader.read("MULTIPOINT(20 10, 20 20, 30 20, 30 30, 10 10)");
      assertTrue(!m.equalsExactGeom(unexpectedValue!));
    });
    test("testNormalizeLineString1", () {
      Geometry? l =
          reader.read("LINESTRING (20 20, 160 40, 160 100, 100 120, 60 60)");
      l!.normalize();
      Geometry? expectedValue =
          reader.read("LINESTRING (20 20, 160 40, 160 100, 100 120, 60 60)");
    ...
    test("testNormalizeLineString3", () {
      Geometry? l =
          reader.read("LINESTRING (200 240, 140 160, 80 160, 160 80, 80 80)");
      l!.normalize();
      Geometry? expectedValue =
          reader.read("LINESTRING (80 80, 160 80, 80 160, 140 160, 200 240)");
      assertEqualsExact(expectedValue!, l);
    });
    ...
    test("testNormalizeStringNoSideEffect", () {
      Geometry? l =
          reader.read("LINESTRING (200 240, 140 160, 80 160, 160 80, 80 80)");
      Geometry? ref = reader.read("LINESTRING (200 240, 140 160)");
      LineString seg = l!
          .getFactory()
          .createLineString([l.getCoordinates()[0], l.getCoordinates()[1]]);
      assertEqualsExact(ref!, seg);
      l.normalize();
      assertEqualsExact(ref, seg);
    });
    test("testNormalizeEmptyLineString", () {
      Geometry? l = reader.read("LINESTRING EMPTY");
      l!.normalize();
      Geometry? expectedValue = reader.read("LINESTRING EMPTY");
      assertEqualsExact(expectedValue!, l);
    });
    test("testNormalizeEmptyPolygon", () {
      Geometry? actualValue = reader.read("POLYGON EMPTY");
      actualValue!.normalize();
      Geometry? expectedValue = reader.read("POLYGON EMPTY");
      assertEqualsExact(expectedValue!, actualValue);
    });
    test("testNormalizePolygon1", () {
      Geometry? actualValue = reader.read(
  ...
  group("MultiPointImplTest - ", () {
    ...
    test("testEquals", () {
      Geometry? m1 = reader.read("MULTIPOINT(5 6, 7 8)");
      Geometry? m2 = reader.read("MULTIPOINT(5 6, 7 8)");
  ...
  group("LineStringImplTest - ", () {
    ...
    test("testIsSimple", () {
      Geometry? l1 = reader.read("LINESTRING (0 0, 10 10, 10 0, 0 10, 0 0)");
      assertTrue(!l1!.isSimple());
      Geometry? l2 = reader.read("LINESTRING (0 0, 10 10, 10 0, 0 10)");
      assertTrue(!l2!.isSimple());
    });
    test("testIsCoordinate", () {
      LineString l =
          reader.read("LINESTRING (0 0, 10 10, 10 0)")! as LineString;
      assertTrue(l.isCoordinate(new Coordinate(0, 0)));
      assertTrue(!l.isCoordinate(new Coordinate(5, 0)));
    });
    test("testEquals", () {
      Geometry? l1 = reader.read("LINESTRING(1.111 2.222, 3.333 4.444)");
      Geometry? l2 = reader.read("LINESTRING(1.111 2.222, 3.333 4.444)");
    ...
    test("testGetCoordinates", () {
      Geometry? l =
          reader.read("LINESTRING(1.111 2.222, 5.555 6.666, 3.333 4.444)");
      List<Coordinate> coordinates = l!.getCoordinates();
      assertEquals(new Coordinate(5.555, 6.666), coordinates[1]);
    });
    test("testIsClosed", () {
      LineString l = reader.read("LINESTRING EMPTY")! as LineString;
    ...
    test("testEqualsML", () {
      WKTReader reader = new WKTReader.withFactory(
          new GeometryFactory.withPrecisionModelSrid(
              new PrecisionModel.fixedPrecision(1000), 0));
      ...
      reader = new WKTReader.withFactory(
          new GeometryFactory.withPrecisionModelSrid(
              new PrecisionModel.fixedPrecision(1), 0));
      l1 = reader.read(
          "MULTILINESTRING((1732328800 519578384, 1732026179 519976285, 1731627364 519674014, 1731929984 519276112, 1732328800 519578384))");
      l2 = reader.read(
          "MULTILINESTRING((1731627364 519674014, 1731929984 519276112, 1732328800 519578384, 1732026179 519976285, 1731627364 519674014))");
    ...
    test("testFiveZeros", () {
      LineString ls = new GeometryFactory.defaultPrecision().createLineString([
        new Coordinate(0, 0),
        new Coordinate(0, 0),
        new Coordinate(0, 0),
        new Coordinate(0, 0),
  ...
  group("GeometryImplTest - ", () {
    ...
    test("testComparable", () {
      ...
      assertTrue(
          CollectionsUtils.areEqual(geometries, geometriesExpectedOrder));
    });
    test("testPolygonRelate", () {
      Geometry bigPolygon =
          reader.read("POLYGON ((0 0, 0 50, 50 50, 50 0, 0 0))")!;
      Geometry smallPolygon =
          reader.read("POLYGON ((10 10, 10 30, 30 30, 30 10, 10 10))")!;
    ...
    test("testEmptyGeometryCentroid", () {
      ...
      assertTrue(
          reader.read("GEOMETRYCOLLECTION EMPTY")!.getCentroid().isEmpty());
      assertTrue(reader
          .read(
    ...
    test("testEquals", () {
      ...
      Geometry differentStart =
          reader.read("POLYGON ((0 50, 50 50, 50 0, 0 0, 0 50))")!;
      Geometry differentFourth =
          reader.read("POLYGON ((0 0, 0 50, 50 50, 50 -99, 0 0))")!;
      Geometry differentSecond =
          reader.read("POLYGON ((0 0, 0 99, 50 50, 50 0, 0 0))")!;
    ...
    test("testEquals1", () {
      Geometry polygon1 =
          reader.read("POLYGON ((0 0, 0 50, 50 50, 50 0, 0 0))")!;
      Geometry polygon2 =
          reader.read("POLYGON ((50 50, 50 0, 0 0, 0 50, 50 50))")!;
    ...
    test("testEqualsExactForLinearRings", () {
      LinearRing x = geometryFactory.createLinearRing([
        Coordinate(0, 0),
        Coordinate(100, 0),
        Coordinate(100, 100),
        Coordinate(0, 0)
      ]);
      LinearRing somethingExactlyEqual = geometryFactory.createLinearRing([
        Coordinate(0, 0),
        Coordinate(100, 0),
        Coordinate(100, 100),
        Coordinate(0, 0)
      ]);
      LinearRing somethingNotEqualButSameClass = geometryFactory
          .createLinearRing([
        Coordinate(0, 0),
        Coordinate(100, 0),
        Coordinate(100, 555),
      ...
      LinearRing anotherSameClassButEmpty =
          geometryFactory.createLinearRingSeq(null);
      ...
      doTestEqualsExact(
          ...
          (geometryFactory, geometries) => geometryFactory
              .createMultiLineString(geometries.cast<LineString>()),
          geometryFactory,
          reader);
    ...
    test("testEqualsExactForLineStrings", () {
      ...
      LineString somethingExactlyEqual = geometryFactory.createLineString(
          [Coordinate(0, 0), Coordinate(100, 0), Coordinate(100, 100)]);
      LineString somethingNotEqualButSameClass = geometryFactory
          .createLineString(
              [Coordinate(0, 0), Coordinate(100, 0), Coordinate(100, 555)]);
      LineString sameClassButEmpty = geometryFactory.createLineString(null);
      LineString anotherSameClassButEmpty =
          geometryFactory.createLineString(null);
      doTestEqualsExact(
          x,
          somethingExactlyEqual,
          somethingNotEqualButSameClass,
    ...
    test("testEqualsExactForPoints", () {
      ...
      Point somethingExactlyEqual =
          geometryFactory.createPoint(Coordinate(100, 100));
      Point somethingNotEqualButSameClass =
          geometryFactory.createPoint(Coordinate(999, 100));
      ...
      doTestEqualsExact(
          ...
          sameClassButEmpty,
          anotherSameClassButEmpty,
          (geometryFactory, geometries) =>
              geometryFactory.createMultiPoint(geometries.cast<Point>()),
          geometryFactory,
          reader);
    });
    test("testEqualsExactForPolygons", () {
      Geometry? x = reader.read("POLYGON ((0 0, 0 50, 50 50, 50 0, 0 0))");
      Geometry? somethingExactlyEqual =
          reader.read("POLYGON ((0 0, 0 50, 50 50, 50 0, 0 0))");
      Geometry? somethingNotEqualButSameClass =
          reader.read("POLYGON ((50 50, 50 0, 0 0, 0 50, 50 50))");
      Geometry? sameClassButEmpty = reader.read("POLYGON EMPTY");
      Geometry? anotherSameClassButEmpty = reader.read("POLYGON EMPTY");
      doTestEqualsExact(
          x!,
          somethingExactlyEqual!,
          somethingNotEqualButSameClass!,
          ...
          anotherSameClassButEmpty!,
          (geometryFactory, geometries) =>
              geometryFactory.createMultiPolygon(geometries.cast<Polygon>()),
          geometryFactory,
          reader);
    });
    test("testEqualsExactForGeometryCollections", () {
      ...
      GeometryCollection x =
          geometryFactory.createGeometryCollection([polygon1, polygon2]);
      GeometryCollection somethingExactlyEqual =
          geometryFactory.createGeometryCollection([polygon1, polygon2]);
      GeometryCollection somethingNotEqualButSameClass =
          geometryFactory.createGeometryCollection([polygon2]);
      GeometryCollection sameClassButEmpty =
          geometryFactory.createGeometryCollection(null);
      GeometryCollection anotherSameClassButEmpty =
          geometryFactory.createGeometryCollection(null);
    ...
    test("testGeometryCollectionIntersects1", () {
      ...
      Geometry gc1 =
          reader.read("GEOMETRYCOLLECTION ( LINESTRING(0 0, 1 1) )")!;
      Geometry gc2 =
          reader.read("GEOMETRYCOLLECTION ( LINESTRING(1 0, 0 1) )")!;
...
void doTestEqualsExact(
  ...
  Geometry somethingEqualButNotExactly =
      geometryFactory.createGeometryCollection([x]);

  doTestEqualsExact2(
      x,
      somethingExactlyEqual,
      collectionFactory(geometryFactory, [x]),
      somethingNotEqualButSameClass,
      reader);

  doTestEqualsExact2(sameClassButEmpty, anotherSameClassButEmpty,
      emptyDifferentClass, x, reader);

  /**
   * Test comparison of non-empty versus empty.
   */
  doTestEqualsExact2(
      x, somethingExactlyEqual, sameClassButEmpty, sameClassButEmpty, reader);

  doTestEqualsExact2(
      collectionFactory(geometryFactory, [x, x]),
      collectionFactory(geometryFactory, [x, somethingExactlyEqual]),
      somethingEqualButNotExactly,
      collectionFactory(geometryFactory, [x, somethingNotEqualButSameClass]),
      reader);
}
...
void doTestEquals(Geometry a, Geometry b, bool equalsGeometry,
...
typedef CollectionFactory = Geometry Function(
    GeometryFactory geometryFactory, List<Geometry> geometries);

void preciseCoordinateTester(
...
void doPredicatesG(Geometry a, Geometry b) {
  ...
  assertTrue(a.crosses(b) ==
      a.relate(b).isCrosses(a.getDimension(), b.getDimension()));
  assertTrue(a.disjoint(b) == a.relate(b).isDisjoint());
  assertTrue(
      a.equals(b) == a.relate(b).isEquals(a.getDimension(), b.getDimension()));
  assertTrue(a.intersects(b) == a.relate(b).isIntersects());
  assertTrue(a.overlaps(b) ==
      a.relate(b).isOverlaps(a.getDimension(), b.getDimension()));
  assertTrue(a.touches(b) ==
      a.relate(b).isTouches(a.getDimension(), b.getDimension()));
