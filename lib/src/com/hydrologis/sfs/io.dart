...
//   static CoordinateSequenceFactory csFactoryXYZM = CoordinateArraySequenceFactory.instance();
...
// */
// CoordinateSequence getCoordinate(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags, bool tryParen)
...
// *@throws  ParseException  if an unexpected token was encountered
// */
// CoordinateSequence getCoordinateSequence(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags)
//throws IOException, ParseException {
...
// */
// int toDimension(EnumSet<Ordinate> ordinateFlags) {
//  int dimension = 2;
//  if (ordinateFlags.contains(Ordinate.Z))
//    dimension++;
//  if (ordinateFlags.contains(Ordinate.M))
...
// */
// CoordinateSequence mergeSequences(ArrayList sequences, EnumSet<Ordinate> ordinateFlags) {
//
...
// */
// Coordinate[] getCoordinates(StreamTokenizer tokenizer) throws IOException, ParseException {
...
// *@deprecated in favor of functions returning {@link CoordinateSequence}s
// */
// Coordinate[] getCoordinatesNoLeftParen(StreamTokenizer tokenizer) throws IOException, ParseException {
...
// *@deprecated in favor of functions returning {@link CoordinateSequence}s
// */
// Coordinate getPreciseCoordinate(StreamTokenizer tokenizer)
//throws IOException, ParseException
//{
...
// * @throws  IOException     if an I/O error occurs
// */
// static bool isNumberNext(StreamTokenizer tokenizer) throws IOException {
...
// * @throws  IOException     if an I/O error occurs
// */
// static bool isOpenerNext(StreamTokenizer tokenizer) throws IOException {
//int type = tokenizer.nextToken();
//tokenizer.pushBack();
//return type == '(';
//}
...
// * @throws  IOException     if an I/O error occurs
// */
// double getNextNumber(StreamTokenizer tokenizer) throws IOException,
//    ParseException {
//int type = tokenizer.nextToken();
//switch (type) {
...
// * @param  tokenizer        tokenizer over a stream of text in Well-known Text
// */
// static String getNextEmptyOrOpener(StreamTokenizer tokenizer) throws IOException, ParseException {
...
// * @param  tokenizer        tokenizer over a stream of text in Well-known Text
// */
// static EnumSet<Ordinate> getNextOrdinateFlags(StreamTokenizer tokenizer) throws IOException, ParseException {
//
...
// *@throws  IOException     if an I/O error occurs
// */
// static String lookAheadWord(StreamTokenizer tokenizer) throws IOException, ParseException {
//String nextWord = getNextWord(tokenizer);
//tokenizer.pushBack();
//return nextWord;
//}
...
// * @param  tokenizer        tokenizer over a stream of text in Well-known Text
// */
// static String getNextCloserOrComma(StreamTokenizer tokenizer) throws IOException, ParseException {
//String nextWord = getNextWord(tokenizer);
...
// *@throws  IOException     if an I/O error occurs
// */
// String getNextCloser(StreamTokenizer tokenizer) throws IOException, ParseException {
//String nextWord = getNextWord(tokenizer);
...
// * @param  tokenizer        tokenizer over a stream of text in Well-known Text
// */
// static String getNextWord(StreamTokenizer tokenizer) throws IOException, ParseException {
//int type = tokenizer.nextToken();
//switch (type) {
//case StreamTokenizer.TT_WORD:
//
...
// */
// static ParseException parseErrorExpected(StreamTokenizer tokenizer, String expected)
//{
...
// * @throws AssertionFailedException if an invalid token is encountered
// */
// static ParseException parseErrorWithLine(StreamTokenizer tokenizer, String msg)
//{
...
// */
// static String tokenString(StreamTokenizer tokenizer)
//{
...
// * @param  tokenizer        tokenizer over a stream of text in Well-known Text
// */
// Geometry readGeometryTaggedText(StreamTokenizer tokenizer) throws IOException, ParseException {
//String type;
//
...
//}
//
// Geometry readGeometryTaggedText(StreamTokenizer tokenizer, String type, EnumSet<Ordinate> ordinateFlags)
//throws IOException, ParseException {
//
...
// *@throws  ParseException  if an unexpected token was encountered
// */
// Point readPointText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags) throws IOException, ParseException {
...
// *@throws  ParseException  if an unexpected token was encountered
// */
// LineString readLineStringText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags) throws IOException, ParseException {
...
// *      encountered
// */
// LinearRing readLinearRingText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags)
//throws IOException, ParseException
//{
...
// *@throws  ParseException  if an unexpected token was encountered
// */
// MultiPoint readMultiPointText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags) throws IOException, ParseException
//{
...
// *@throws  IOException     if an I/O error occurs
// */
// Polygon readPolygonText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags) throws IOException, ParseException {
//String nextToken = getNextEmptyOrOpener(tokenizer);
//if (nextToken.equals(EMPTY)) {
...
// *@throws  ParseException  if an unexpected token was encountered
// */
// MultiLineString readMultiLineStringText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags)
//throws IOException, ParseException {
//String nextToken = getNextEmptyOrOpener(tokenizer);
//if (nextToken.equals(EMPTY)) {
...
// *@throws  IOException     if an I/O error occurs
// */
// GeometryCollection readGeometryCollectionText(StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags) throws IOException, ParseException {
//String nextToken = getNextEmptyOrOpener(tokenizer);
//if (nextToken.equals(EMPTY)) {
