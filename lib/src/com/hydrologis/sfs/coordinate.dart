...
class Coordinate implements Comparable<Coordinate> {
  ...
  Coordinate.empty2D() : this.fromXY(0.0, 0.0);

  ///  Constructs a <code>Coordinate</code> having the same (x,y,z) values as
  ///  <code>other</code>.
  ///
  ///@param  c  the <code>Coordinate</code> to copy.
  Coordinate.fromCoordinate(Coordinate c) : this(c.x, c.y, c.getZ());

  ///  Constructs a <code>Coordinate</code> at (x,y,NaN).
  ///
  ///@param  x  the x-value
  ///@param  y  the y-value
  Coordinate.fromXY(double x, double y) : this(x, y, NULL_ORDINATE);
  ...
  Coordinate operator -(Coordinate other) {
    return Coordinate.fromXY(x - other.x, y - other.y);
  }
...
//  double _m;
//
//  Coordinate(double x, double y, [double z, double m]) {
//    this._x = x;
//    this._y = y;
//    this._z = z;
//    this._m = m;
//  }
//
//  Coordinate.emptyDefault() : this.empty(2, 0);
//
//  Coordinate.empty(int dimension, int measures) {
//    if (dimension == 2) {
//      _x = 0.0;
//      _y = 0.0;
//      _z = null;
